...
def init_model():
    ...
    parser.add_argument("--name", default='banking_k1_bz512_lr5e-5_lrp5e-5_seed62_aug2_augp', type=str)

    parser.add_argument("--save_results_path", type=str, default='outputs', help="The path to save results.")

    parser.add_argument("--pretrain_dir", default='pre_model_output', type=str,
    ...
    parser.add_argument("--freeze_bert_parameters_pretrain", default=True,
                        help="Freeze the last parameters of BERT.")

    parser.add_argument("--freeze_bert_parameters_em", default= True, help="Freeze some parameters of BERT during EM.")

    parser.add_argument("--save_model_pre", default="False", help="Save trained model.")

    parser.add_argument("--save_model", default=True, type = bool, help="Save trained model.")

    parser.add_argument("--augment_data_simcse", action="store_true", help="data augment using simcse embedding ")

    parser.add_argument("--augment_data", default="True", help="data augment using our method")

    parser.add_argument("--pretrain", type=bool, default = False , help="Pre-train the model with labeled data.")
    ...
    parser.add_argument('--seed', type=int, default=62, help="Random seed for initialization. we choose 42 52 62")
    ...
    parser.add_argument("--num_pretrain_epochs", default=0, type=float,
